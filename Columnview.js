...
class Columnview{
    ...
    createVertex(){
        var col = this.column;
        this.vertex = this.graph.insertVertex(this.graph.getDefaultParent(), null,col.text,this.pos,3*cellSpacing, colIconSize, colIconSize,defaultHeadStyle+'image=resources/data/'+col.image+'.png;');
